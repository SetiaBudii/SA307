...
image_folder = (
    "../../Dataset/LoveDA/val/masks_png" # CEK PATH SEBELUM RUN CODE
)
...
for image_name in os.listdir(image_folder):
    ...
    if annotations:
        gt_image_pil.save(f"../../Dataset/LoveDA/agriculture/val/masks_1_class/{image_info['file_name']}")

        source = f"../../Dataset/LoveDA/val/images_png/{image_info['file_name']}"
        destination = f"../../Dataset/LoveDA/agriculture/val/images_png/{image_info['file_name']}"
