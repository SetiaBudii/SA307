...
def main(args):
    ...
    ious = []
    test_data = test_data[args.indexImage]
    ...
    show_points(point_awal, label1, axes[2], marker_size=20)
    ...
    save_path = os.path.join(output_folder, f"result_inference_{args.indexImage}.png")
    plt.tight_layout()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--indexImage", type=int, required=True, help="Path Image")
