...
def load_datasets(cfg, img_size):
    ...
    train = LOVEDADataset(
        cfg,
        root_dir=cfg.datasets.LOVEDA.root_dir,
        annotation_file=cfg.datasets.LOVEDA.annotation_file_train,
        transform=transform,
        training=True,
    )
    ...
    val = LOVEDADataset(
        cfg,
        root_dir=cfg.datasets.LOVEDA.root_dir,
        annotation_file=cfg.datasets.LOVEDA.annotation_file_val,
        transform=transform,
    )
