...
log_file_val_path = os.path.join(log_dir, f"validate_log_{timestamp}.txt")
...
plot_miou(epochs_train, miou_train, save_path=os.path.join(metric_dir, 'miou_per_epoch_train.png'))
plot_loss(epochs_train, loss_train, save_path=os.path.join(metric_dir, 'loss_per_epoch_train.png'))
plot_miou(epochs_val, miou_val, save_path=os.path.join(metric_dir, 'miou_per_epoch_val.png'))
plot_loss(epochs_val, loss_val, save_path=os.path.join(metric_dir, 'loss_per_epoch_val.png'))
